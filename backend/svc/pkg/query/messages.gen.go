...
func newMessage(db *gorm.DB, opts ...gen.DOOption) message {
	...
	_message.messageDo.UseModel(&domain.Message{})
	...
	_message.SpotID = field.NewString(tableName, "spot_id")
	_message.PhotoURL = field.NewString(tableName, "photo_url")
...
func (m *message) updateTableName(table string) *message {
	...
	m.SpotID = field.NewString(table, "spot_id")
	m.PhotoURL = field.NewString(table, "photo_url")
...
func (m *message) fillFieldMap() {
	...
	m.fieldMap["spot_id"] = m.SpotID
	m.fieldMap["photo_url"] = m.PhotoURL
...
type IMessageDo interface {
	...
	Unscoped() IMessageDo
	Create(values ...*domain.Message) error
	CreateInBatches(values []*domain.Message, batchSize int) error
	Save(values ...*domain.Message) error
	First() (*domain.Message, error)
	Take() (*domain.Message, error)
	Last() (*domain.Message, error)
	Find() ([]*domain.Message, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*domain.Message, err error)
	FindInBatches(result *[]*domain.Message, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*domain.Message) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*domain.Message, error)
	FirstOrCreate() (*domain.Message, error)
	FindByPage(offset int, limit int) (result []*domain.Message, count int64, err error)
...
func (m messageDo) Create(values ...*domain.Message) error {
	if len(values) == 0 {
		return nil
	}
...
func (m messageDo) CreateInBatches(values []*domain.Message, batchSize int) error {
	return m.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (m messageDo) Save(values ...*domain.Message) error {
	if len(values) == 0 {
		return nil
	}
...
func (m messageDo) First() (*domain.Message, error) {
...
func (m messageDo) Take() (*domain.Message, error) {
...
func (m messageDo) Last() (*domain.Message, error) {
...
func (m messageDo) Find() ([]*domain.Message, error) {
	result, err := m.DO.Find()
	return result.([]*domain.Message), err
}

func (m messageDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*domain.Message, err error) {
...
func (m messageDo) FindInBatches(result *[]*domain.Message, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (m messageDo) FirstOrInit() (*domain.Message, error) {
...
func (m messageDo) FirstOrCreate() (*domain.Message, error) {
...
func (m messageDo) FindByPage(offset int, limit int) (result []*domain.Message, count int64, err error) {
...
func (m messageDo) Delete(models ...*domain.Message) (result gen.ResultInfo, err error) {
