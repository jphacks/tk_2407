...
func newTest(db *gorm.DB, opts ...gen.DOOption) test {
	...
	_test.testDo.UseModel(&domain.Test{})
	...
	_test.Test = field.NewString(tableName, "test")
...
type ITestDo interface {
	...
	Unscoped() ITestDo
	Create(values ...*domain.Test) error
	CreateInBatches(values []*domain.Test, batchSize int) error
	Save(values ...*domain.Test) error
	First() (*domain.Test, error)
	Take() (*domain.Test, error)
	Last() (*domain.Test, error)
	Find() ([]*domain.Test, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*domain.Test, err error)
	FindInBatches(result *[]*domain.Test, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*domain.Test) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*domain.Test, error)
	FirstOrCreate() (*domain.Test, error)
	FindByPage(offset int, limit int) (result []*domain.Test, count int64, err error)
...
func (t testDo) Create(values ...*domain.Test) error {
	if len(values) == 0 {
		return nil
	}
...
func (t testDo) CreateInBatches(values []*domain.Test, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t testDo) Save(values ...*domain.Test) error {
	if len(values) == 0 {
		return nil
	}
...
func (t testDo) First() (*domain.Test, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*domain.Test), nil
	}
}

func (t testDo) Take() (*domain.Test, error) {
...
func (t testDo) Last() (*domain.Test, error) {
...
func (t testDo) Find() ([]*domain.Test, error) {
	result, err := t.DO.Find()
	return result.([]*domain.Test), err
}

func (t testDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*domain.Test, err error) {
	buf := make([]*domain.Test, 0, batchSize)
...
func (t testDo) FindInBatches(result *[]*domain.Test, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t testDo) FirstOrInit() (*domain.Test, error) {
...
func (t testDo) FirstOrCreate() (*domain.Test, error) {
...
func (t testDo) FindByPage(offset int, limit int) (result []*domain.Test, count int64, err error) {
...
func (t testDo) Delete(models ...*domain.Test) (result gen.ResultInfo, err error) {
